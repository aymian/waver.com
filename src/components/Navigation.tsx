...
const Navigation = () => {
  ...
  const navLinks = ["Home", "Courses", "Resources", "Blog"];
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          {/* Centered Navigation Links with Enhanced Hover */}
            ...
            >
              ...
              {navLinks.map((link, index) => (
                <motion.a
                  ...
                  className={`relative px-6 py-2 text-sm font-semibold transition-all duration-300 rounded-full z-10 ${
                    activeLink === link
                      ? "text-primary"
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <BookOpen className="w-5 h-5 text-foreground group-hover:text-primary transition-colors duration-300" />
              <BadgeCheck className="absolute -top-1 -right-1 w-3 h-3 text-primary" />
            </motion.button>
      ...
      <AnimatedSearch isOpen={isSearchOpen} onClose={() => setIsSearchOpen(false)} />
      
      {/* Courses Modal */}
      <CoursesModal open={isCoursesOpen} onOpenChange={setIsCoursesOpen} />
    </>
  );
};
